...
const routes: Routes = [
  ...
  { path: 'admin/products/new', component: AdminProductsFormComponent, canActivate: [ AuthGuard ] },
  { path: 'admin/products/:id', component: AdminProductsFormComponent, canActivate: [ AuthGuard ] },
